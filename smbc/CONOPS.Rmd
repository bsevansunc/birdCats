...
*	**0615-0645**: NZP staff and volunteers will set up the banding station and open nets  
...
*	**1215-1230**: NZP staff and volunteers gather to discuss the banding day (e.g., any difficulties encountered, lessons learned)  

MID-MORNING, EARLY AFTERNOON BANDING:

*	**0800-0815**: Preparatory meeting at the banding station (e.g., Amazonia, see map) 
*	**0815-0845**: NZP staff and volunteers will set up the banding station and open nets
...
*	**1415-1430**: NZP staff and volunteers gather to discuss the banding day (e.g., any difficulties encountered, lessons learned) 

LATE-MORNING, AFTERNOON BANDING:

*	**1000-1015**: Preparatory meeting at the banding station (e.g., Amazonia, see map)
*	**1015-1045**: NZP staff and volunteers will set up the banding station and open nets
...
*	**1615-1630**: NZP staff and volunteers gather to discuss the banding day (e.g., any difficulties encountered, lessons learned) 

**Staffing needs**: This phase of the project will require two NZP staff members per banding day to assist with extracting birds from nets and banding.  
...
**Description of activity**: NZP staff will conduct training of 4-6 volunteers or interns, each of whom are expected to volunteer one day per week. Volunteers and interns will be required to complete zoonosis training. Individuals may not interact with NZP collection birds on the day of trapping. If volunteers work for the Bird House, they are not to wear the same clothing worn for trapping to the Bird House. If the predicted weather conditions do not allow for banding, volunteers will be informed via email that their shift for that day has been cancelled. The full volunteer protocol document may be viewed at [this link](https://github.com/bsevansunc/birdCats/blob/master/smbc/nzpBanding_volunteerProtocols.pdf). The timeline for training includes: 

* **Week 1**: Volunteers will observe extraction and processing of birds
* **Week 2**: Volunteers will observe processing of birds and learn to extract House Sparrows from nets under the guidance of NZP staff
* **Week 3**: Under the guidance of NZP staff, volunteers will learn to process birds and extract House Sparrows from nets
* **Weeks 4-7**: Volunteers will be allowed to extract House Sparrows without staff guidance. Under the guidance of NZP staff, volunteers will learn to process birds and learn to extract other species from nets
...
**Staffing needs**: This phase of the project will require two NZP staff members per banding day to assist with extracting birds from nets and banding. We will require 2-4 volunteers and/or interns per banding day. Volunteers will assist with data entry and will be trained on the extraction of birds during by NZP staff. 
...
**Description of activity**: NZP staff will conduct demonstration banding activites at banding stations (see map above). 

**Staffing needs**: This phase of the project will require two NZP staff members per banding day to assist with extracting birds from nets and banding. We will require 2-4 volunteers and/or interns per banding day.
